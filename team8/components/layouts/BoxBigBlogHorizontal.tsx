...
function BoxBigBlogHorizontal({id, title, image, content, postTime, countComments, className = ''}: {
    id: string,
    title: string,
    image: string,
    content: string,
    ...
    return (
        <Link href={`/product/${id}`} className={'group md:flex md:w-[720px] lg:w-[616px] xl:w-[847.5px]' + ` ${className}`}>
            <div className="p-[5px] w-full max-w-96 group-hover:border-[#0083c1] border border-solid border-[#ccc] rounded md:h-[242px] lg:w-[281px] lg:h-[193px] xl:w-[388px] xl:h-[260px]">
                <div className="relative w-full aspect-[390/260]">
            ...
            <div className="flex flex-col pt-[11px] pl-[23px] w-full lg:w-[333px] xl:w-[458px]">
                ...
                <div className="w-full text-[rgba(0,0,0,0.7)] text-[12px] pb-[10px]">
                    <p>{content}</p>
                </div>
...
export default BoxBigBlogHorizontal;