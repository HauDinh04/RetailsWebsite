...
export default function Post({ slug, thumbnail_url, title, description, comment_count, datetime }: PostType) {
    ...
    <div className='flex flex-col md:flex-row gap-2 mb-5 group'>
      ...
      <div className='p-2 w-full md:w-[54%]'>
        ...
        <div className='mt-[16px] mb-[22px] flex justify-between text-[12px]'>
          ...
          <Link
            href={`/blog/${slug}`}
            className='flex items-center gap-1  text-[#0083c1] cursor-pointer hover:text-red-500'>
