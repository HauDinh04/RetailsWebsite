...
function SkinCssPopup() {
    const dispatch = useAppDispatch();
    const isShow = useAppSelector(state => state.skin.isShowSkinCss);

    const handleHideSkinCss = () => {
        dispatch(setSkin(false));
    }
                ...
                <AnimatePresence>
                    <motion.div onClick={(e) => e.stopPropagation()}
                        ...
                        <div className="p-[15px] flex justify-between items-center text-[#555555] ">
                            ...
                            <MdClose
                                className={'text-[18px] font-bold cursor-pointer hover:font-black hover:text-black'}
                                onClick={handleHideSkinCss}/>
                        </div>
                        <div className="p-[15px] border border-solid border-[#e5e5e5]">
                        <textarea
                            className="w-full block text-[12px] text-[#666666] border border-solid border-[#666] h-[525px]">
                        {`
/********************************************
