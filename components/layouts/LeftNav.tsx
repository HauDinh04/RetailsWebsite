    ...
    return (
        <div className=" xl:grid grid-cols-1 items-start  border  w-[250px] rounded-lg  hidden absolute top-0  ">
            ...
            {leftNavLinks.map((link, index) => (
                <div
                    className="group px-[9px] bg-[#F8F8F8] py-[10px] border items-center text-left  "
                    key={index}
                >
                    <Link
                        href={link.url}
                        key={link.label}
                        className="text-sub-heading text-[#444] hover:text-bg-main transition-all 0.5s flex justify-between gap-2 items-center"
                    >
                        {link.label}
                    ...
                    {link.subLinks && (
                        <div
                            className=" hidden group-hover:block absolute z-10 p-4 left-full top-0 w-[875px] bg-white border shadow-lg ">
            ...
            <div className="bg-[#F8F8F8] transition-all 0.3s ease-in-out z-1">
                {showMoreCategories && (
                    <div className="transition-all duration-300 ease-in-out">
                        <div
                            className="px-[11px] bg-[#F8F8F8] py-[13px] border items-center text-left hover:text-bg-main transition-all 0.5">
                ...
                <button
                    className="px-[11px] bg-[#F8F8F8] py-[13px] flex text-left items-center gap-2 text-4  hover:text-bg-main transition-all 0.5"
