...
import {getUserFromLocalStorage, getIsLoginFromLocalStorage} from "@/redux/features/account/account.slice";
                ...
                <div className="container">
                    <div className="mx-[-15px] flex flex-row items-center justify-between text-[#555555]">
                        <div className="basis-1/2 flex flex-wrap items-center justify-start">
                            <div
                                className="relative group px-5 after:absolute after:top-[14px] after:right-0 after:h-[13px] after:w-[1px] after:bg-[#cccccc]">
                                <div
                                    className="flex h-[40px] items-center justify-start text-caption hover:text-[#337ab7] cursor-pointer">
                ...
                <div className="container">
                    <div className="mx-[-15px]">
                        <div className="flex flex-row flex-wrap lg:flex-nowrap justify-between">
                            ...
                            <div
                                className="md:order-3 order-2 basis-5/12 sm:basis-4/12 flex flex-row md:items-center justify-end lg:justify-end xl:justify-between pl-[18px]">
                                ...
                                <div className="pr-[15px] relative">
                                    ...
                                    >
                                        <div className="flex flex-row">
                                            <div
                                                className="relative aspect-square w-[31px] h-[40px] my-[5px] mx-[10px]">
                                                <Image
                                                    src="/images/cart.png"
                                                    alt="cart"
                                                    fill sizes={'100'}
                                                ...
                                                />
                                                <div
                                                    className="w-[22px] h-[22px] rounded-full bg-[#ff5555] absolute left-[-10px] bottom-[-8px] text-white-1">
                                                    2
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <div className="mb-[20px]">
                                                    <div
                                                        className="flex flex-row items-center justify-between text-black-2 text-sub-heading font-bold py-2 px-2">
                                                        <p className="">
                                                            Sub-Total
                                                        </p>
