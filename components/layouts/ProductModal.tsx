      ...
      <div className='bg-white rounded-sm p-6 max-w-[1000px] w-full relative'>
        ...
        <div className='grid grid-cols-2 gap-8'>
            ...
            <Carousel className='mt-5'>
              <CarouselContent>
                {images.map((image, index) => {
                  return (
                    <CarouselItem className='basis-1/4' key={index} onClick={() => setThumbnails(image)}>
                      <Image
                        src={image}
                        alt=''
                        width={0}
          ...
          <div className='text-[12px]'>
            ...
            <div className='flex gap-1 my-8'>{renderStars(star)}</div>
            ...
            <div className='flex gap-2 mt-4 items-end'>
              ...
              <div className='line-through text-[18px] text-gray-500 mb-2'>${discount_price.toFixed(2)}</div>
            </div>
              ...
              <div className='text-[14px] font-bold text-gray-600 flex items-center gap-3'>
                ...
                <div className='border rounded-md w-[80px] p-2 flex divide-x'>
                  ...
                  <div className='px-1 ps-2'>
                    <FaChevronUp className='text-[8px] mb-1 cursor-pointer' onClick={handleIncrement} />
                    <hr />
                    <FaChevronDown className='text-[8px] mt-1 cursor-pointer' onClick={handleDecrement} />
                  </div>
                </div>
              </div>
