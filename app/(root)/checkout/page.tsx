            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col sm:flex-row bg-[#f5f5f5] py-5 px-5 ">
                <div className="grid grid-cols-1 w-full sm:w-1/4 gap-5">
                    <div className="grid grid-cols-1 border p-[10px] bg-white ">
                        <div className=" bg-[#5f6874] px-[15px] py-[10px] ">
                            <h4 className="text-white text-[16px] font-semibold">
                                <FaSignInAlt className={'inline'}/> Create an Account or Login
                            </h4>
                        </div>
                    ...
                    <div className="grid grid-cols-1 border p-[10px] bg-white">
                        <div className=" bg-[#5f6874] px-[15px] py-[10px]">
                            <h4 className="text-white text-[16px] font-semibold">
                                <FaUser className={'inline'}/> Your Personal Details
                            </h4>
                        </div>
                    ...
                    <div className="grid grid-cols-1 border p-[10px] bg-white">
                        <div className="bg-[#5f6874] px-[15px] py-[10px] ">
                            <h4 className="text-white text-[16px] font-semibold">
                                <FaBook className={'inline rotate-6'}/> Your Address
                            </h4>
                        </div>
                        <div className="flex flex-col gap-[15px] p-[15px]">
                            ...
                            <div className="flex gap-[10px] text-[12px] text-[#555555] items-center">
                                <input type="checkbox" id={'addressSame'} defaultChecked={true}/>
                ...
                <div className="flex flex-col mt-[20px] w-full sm:mt-0 sm:w-3/4 gap-5 sm:ml-5">
                    <div className="border w-full flex flex-col gap-[20px] sm:gap-0 sm:flex-row justify-between">
                        <div className="w-full sm:w-1/2">
                            <div className="grid grid-cols-1 p-[10px] bg-white">
                                <div className=" bg-[#5f6874] px-[15px] py-[10px] ">
                                    <h4 className="text-white text-[16px] font-semibold">
                                        <FaTruck className={'inline'}/> Delivery Method
                                    </h4>
                                </div>
                        ...
                        <div className="w-full sm:w-1/2">
                            ...
                            <div className="grid grid-cols-1  p-[10px] bg-white ">
                                <div className=" bg-[#5f6874] px-[15px] py-[10px] ">
                                    <h4 className="text-white  text-[16px] font-semibold">
                                        <FaCreditCard className={'inline'}/> Payment Method
                                    </h4>
                                </div>
                    ...
                    <div className="border bg-white ">
                        <div className="px-[15px] py-[10px] bg-[#5f6874] ">
                            <h4 className="text-[16px] leading-4 text-white">
                                <FaTicketAlt className={'inline'}/> Do you Have a Coupon or Voucher?
                            </h4>
                        </div>
                        <div className="grid grid-cols-1 xl:grid-cols-2">
                            <div className="w-full flex p-[15px]">
                                <input
                                    ...
                                    className={inputStyle + ' 2xl:flex-1'}
                                />
                    ...
                    <div className="border bg-white">
                        <div className="px-[15px] py-[10px] bg-[#5f6874] ">
                            <h4 className="text-[16px] leading-4 text-white">
                                <FaShoppingCart className={'inline'}/> Shopping cart
                            </h4>
                        </div>
                        {/* table here */}
                        <div className="overflow-x-auto w-full p-[15px]">
                            <table className="w-full border-collapse border border-gray-300">
                                ...
                                <tr className="bg-gray-200 text-[12px]">
                                    ...
                                    <th className="border border-gray-300 px-4 py-2 w-[110px]">
                                        Unit Price
                                    </th>
                                    <th className="border border-gray-300 px-4 py-2 w-[98px]">
                                        Total
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 break-words text-[12px]">
                                        <Link href={'/'}
                                              className="block border mx-auto w-max p-[5px] solid border-[#ddd]">
                                                    ...
                                                    <TooltipTrigger>
                                                        <div className="absolute border border-solid border-[#2e6da4]
                                                         h-[36px] bg-[#337ab7] hover:bg-[#286090] hover:border-[#204d74] px-4 py-2 right-[48.5px] top-0">
                                                            <FiRefreshCcw
                                                                className={'text-white text-[14px] font-black'}/>
                                                        </div>
                                                    </TooltipTrigger>
                                                    <TooltipContent>
                                                        <p>Update</p>
                                ...
                                <tr className="border-t border-gray-400">
                                    ...
                                    <td className="border border-gray-300 text-right px-4 py-2">$3.75.000</td>
                                </tr>
                                {/* Hàng VAT */}
                                <tr className="border-t border-gray-400">
                                    <td className="border border-gray-300 text-right text-[#555555] font-bold px-4 py-2"
                    ...
                    <div className="border bg-white">
                        <div className="px-[15px] py-[10px] bg-[#5f6874] ">
                            <h4 className="text-[16px] leading-4 text-white">
                                <FaPencilAlt className={'inline'}/> Add Comments About Your Order
                            </h4>
                        </div>
