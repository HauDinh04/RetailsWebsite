        ...
        <div className='mt-4'>
          <div className='py-[10px] grid grid-cols-1 md:grid-cols-3  '>
            <div className='flex border justify-center items-center sm:justify-start p-5'>
              ...
              <div className='ml-4'>
                <h2 className='uppercase text-sub-heading-bold'>free shipping & return </h2>
                <span className='text-info text-price-2'>Free shipping on orders $49</span>
              </div>
            </div>
            <div className='flex justify-center border items-center sm:justify-start p-5'>
              <TbPigMoney className='text-[30px]' />
              <div className='ml-4'>
                <h2 className='uppercase text-sub-heading-bold'>money guarantee</h2>
                <span className='text-info text-price-2'>30 days money back guarantee</span>
              </div>
            </div>
            <div className='flex border justify-center items-center sm:justify-start p-5'>
              <TfiHeadphoneAlt className='text-[30px]' />
              <div className='ml-4'>
                <h2 className='uppercase text-sub-heading-bold'>online support</h2>
                <span className='text-info text-price-2'>We support online 24/24 on day</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <SwiperSlide key={index} className='flex items-center justify-center '>
                <div className='w-full h-auto relative group p-1 border rounded-sm'>
                  ...
                  <div className='absolute top-3 rounded-[3px] left-4 w-[56px] h-[65px] bg-white items-center flex flex-col pointer-events-none z-10'>
                    <p className='text-[24px] font-bold leading-4 mt-[15px] mb-[3px] text-[#0083C1]'>24</p>
                    <p className='text-[12px] mb-[10px] mt-1 text-[#0083C1] leading-4'>Dec</p>
                  </div>
