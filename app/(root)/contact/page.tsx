...
export default function Contact() {
  return (
      <div className="mb-5">
        ...
        <h1 className="text-[30px] text-[#222222] font-light mt-[20px] mb-[10px]">Contact Us</h1>
          ...
          <div className="col-span-12 md:col-span-8">
            ...
            <div className="mt-3 flex flex-col gap-4">
              ...
              <div className="flex justify-end">
                <div
                    className="text-[14px] text-white bg-[#555555] px-[12px] py-[7px] hover:bg-[#0083c1] cursor-pointer">
                  Submit
                </div>
              </div>
            </div>
